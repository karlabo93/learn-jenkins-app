pipeline {
    ...
    environment {
        NETLIFY_SITE_ID = '27b5bbc6-7d79-40b1-8285-f9db587b6b51'
    ...
    stages {
        ...
        stage('AWS'){
            ...
            steps {
                ...
                sh '''
                    ...
                    aws s3 cp index.html s3://learn-jenkins-1337/index.html
                '''
                }
            }
        }
        ...
        stage('Deploy prod') {
            ...
            environment {
                CI_ENVIRONMENT_URL = 'https://heartfelt-smakager-8f0d87.netlify.app'
            }
